        ...
        <S.Main>
          ...
          <S.MainImgBottom>
            ...
            <S.Main_Link_img>
              ...
              <S.GridContainer>
                <S.Link__with_block className="part_one">
                  <S.WitchSpan>УПАКОВКА</S.WitchSpan>
                </S.Link__with_block>
                <S.Link__with_block className="part_two">
                  <S.WitchSpan>ОТКРЫТКИ</S.WitchSpan>
                </S.Link__with_block>
                <S.Link__with_block className="part_three">
                  <S.WitchSpan>БРЕНДИРОВАНИЕ</S.WitchSpan>
                </S.Link__with_block>
                <S.Link__with_block className="part_four">
                  <S.WitchSpan>СУВЕНИРЫ</S.WitchSpan>
                </S.Link__with_block>
                <S.Link__with_block className="part_five">
                  <S.WitchSpan>ЗНАЧКИ</S.WitchSpan>
                </S.Link__with_block>
                <S.Link__with_block className="medals">
